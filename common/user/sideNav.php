<?php
    $activate = $GLOBALS['activate'];
?>
<div id="top">
    <a href="/user" class="img_logo">
        <img src="../assets/images/logo.png" class="full" alt="Crown Nation" />
        <img src="../assets/images/favicon.png" class="half" alt="Crown Nation" />
    </a>
    ...
    <ul>
        ...
        <?php
            ...
            $activePage = $GLOBALS['pt'];

            for($count = 0; $count < count($menu_list); $count++){
                $title = $menu_list[$count]['title'];
                $icon = $menu_list[$count]['icon'];
                $link = $menu_list[$count]['link'];
                $active = $menu_list[$count]['active'] == $activePage ? "active" : "";
